...
create_history = "CREATE TABLE IF NOT EXISTS TransactionHistory (TransactionID SERIAL PRIMARY KEY, Product varchar(255), Amount real, Price real, Timestamp timestamp, UserId int, CONSTRAINT fk_user FOREIGN KEY (UserId) REFERENCES Users(UserId) ON DELETE CASCADE);"
